...
fast_downward_plugin(
    NAME FF_DISTANCE_WRAPPER
    HELP "Distance estimator for the FF heuristic"
    SOURCES
        heuristics/ff_distance_wrapper
...
fast_downward_plugin(
    NAME FLOATING_POINT_EVALUATOR
    HELP "Plugin containing the code for floating point evaluators"
    SOURCES
        floating_point_evaluator/floating_point_evaluator
...
fast_downward_plugin(
    NAME FLOATING_POINT_OPEN_LIST
    HELP "Plugin containing the code for floating point evaluators"
    SOURCES
        floating_point_open_list/alternation_open_list
        floating_point_open_list/best_first_open_list
        floating_point_open_list/floating_point_open_list
        floating_point_open_list/focal_open_list
    DEPENDENCY_ONLY
)

fast_downward_plugin(
    NAME HEURISTIC_ERROR
    HELP "Plugin containing the code for heuristic error computation"
    SOURCES
        heuristic_error/debiased_distance
        heuristic_error/debiased_heuristic
        heuristic_error/heuristic_error
        heuristic_error/one_step_distance_error
        heuristic_error/one_step_error
        heuristic_error/one_step_heuristic_error
        heuristic_error/percentage_based_debiased_heuristic
        heuristic_error/percentage_based_heuristic_error
    DEPENDENCY_ONLY
)
...
fast_downward_plugin(
    ...
    SOURCES
        bounded_cost_search/bounded_cost_explicit_estimation_search
        bounded_cost_search/cost_bound_assumptions_nancy_evaluator
        bounded_cost_search/eager_bounded_cost_search
        bounded_cost_search/linear_relative_error_potential_evaluator
